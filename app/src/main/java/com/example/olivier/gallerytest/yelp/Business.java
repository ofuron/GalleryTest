...
@JsonDeserialize(builder = AutoValue_Business.Builder.class) public abstract class Business
  ...
  @Nullable public abstract ArrayList<Category> categories();

  @Nullable public abstract String displayPhone();

  @Nullable public abstract Double distance();

  @Nullable public abstract String eat24Url();

  @Nullable public abstract String imageUrl();

  @Nullable public abstract Boolean isClaimed();

  @Nullable public abstract Boolean isClosed();

  @Nullable public abstract String menuProvider();

  @Nullable public abstract Long menuDateUpdated();

  @Nullable public abstract String mobileUrl();

  @Nullable public abstract String phone();

  @Nullable public abstract String reservationUrl();

  @Nullable public abstract Integer reviewCount();

  @Nullable public abstract String snippetImageUrl();

  @Nullable public abstract String snippetText();

  @Nullable public abstract String url();

  @Nullable public abstract Double rating();

  @Nullable public abstract String ratingImgUrl();

  @Nullable public abstract String ratingImgUrlLarge();

  @Nullable public abstract String ratingImgUrlSmall();

  @AutoValue.Builder @JsonPOJOBuilder(withPrefix = "")
  @JsonIgnoreProperties(ignoreUnknown = true)
