...
@Module
public class YelpNetModule {

  private String mBaseUrl;

  public YelpNetModule(final String baseUrl) {
    mBaseUrl = baseUrl;
  }

  @Provides
  @Singleton
  OkHttpOAuthConsumer provideHttpAuth() {
  ...
  @Provides
  @Singleton
  OkHttpClient provideHttpClient(final OkHttpOAuthConsumer consumer) {
